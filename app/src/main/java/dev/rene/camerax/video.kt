...
import dev.rene.camerax.databinding.ActivityVideoBinding
...
class video : AppCompatActivity() {
    ...
    private fun captureVideo() {
        ...
        recording = videoCapture.output
            ...
            .apply {
                if (PermissionChecker.checkSelfPermission(this@video,
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Log.e(Selfie.TAG, "Use case binding failed", exc)
            }
